.PHONY: all build html es en setup clean open-es open-en help
...
help:
	...
	@echo ""
	@echo "Targets:"
	@echo "  build    Build HTML + PDF for both languages (default)"
	@echo "  html     Build HTML only (skip PDF)"
	@echo "  es       Build Spanish only (HTML + PDF)"
	@echo "  en       Build English only (HTML + PDF)"
